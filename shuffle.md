...
There byte layout is as follows (fig.1) 
...
The suits occupy bit 6 and 7 and the order is Clubs, Diamonds, Hearts and Spades, The rank occupies bits 2 thru 5. The begins with Aces and ends with Kings (fig.2).
